...
<head>
    <meta charset="UTF-8"/>
    <title>API Specifications - <?php echo e($companyName); ?></title>
    <style type="text/css">
...
<?php if($feed->feedCategory === 'phone-preping'): ?>
    ...
    <?php if(!empty($feed->pingTimeout)): ?>
        <p>There is a timeout of <strong><?php echo e($feed->pingTimeout); ?> seconds</strong> between when the PING is accepted and when the lead may be posted back.</p>
    <?php endif; ?>
    <h5>PING REQUEST</h5>
    <table>
        <thead>
        ...
        <?php $__currentLoopData = array_filter($allowedPingArray); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allowed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($allowed); ?></td>
                <td><?php echo e($findField($allowed, 'fieldDefinition')); ?></td>
                <td><?php echo e(in_array($allowed, $requiredArray) ? 'Yes' : 'No'); ?></td>
                <td><?php echo e($findField($allowed, 'fieldFormat')); ?></td>
                <td><?php echo e($findField($allowed, 'fieldDescription')); ?></td>
            </tr>
...
<?php /**PATH /Users/raghunathsingh/raghu/Leadadmin_acquira/laravel/resources/views/live/apispec.blade.php ENDPATH**/ ?>
    ...
    const handleAddFeed = async () => {
      ...
      try {
        const payload = {
          ...
          revenuePerLeadType: (newFeed.revenuePerLeadType === 'percent' ? 'percent' : 'fixed'),
          revenuePerLead: newFeed.revenuePerLead ? parseFloat(newFeed.revenuePerLead) : 0,
    ...
    const handleUpdateFeed = async () => {
      ...
      try {
        const payload = {
          ...
          revenuePerLeadType: (editingFeed.revenuePerLeadType === 'percent' ? 'percent' : 'fixed'),
          revenuePerLead: editingFeed.revenuePerLead ? parseFloat(editingFeed.revenuePerLead) : 0,

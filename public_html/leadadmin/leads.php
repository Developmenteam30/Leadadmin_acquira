...
if (isset($_REQUEST['a'])) {
    ...
    switch ($_REQUEST['a']) {
        case "addPhoneLedger":
            ...
            if (!empty($_REQUEST['billingCycleStart'])) {
                try {
            ...
            if (!empty($_REQUEST['billingCycleEnd'])) {
                try {
                    ...
                    foreach ($entries as $entry) {
                        if (substr($entry->ledgerMonth, 0, 7) == $month) {
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlentities($entry->billingCycleStart); ?></td>
                                ...
                                <?php if (LeadsSession::isValid([LEADS_SESSION_LEVEL_MANAGER, LEADS_SESSION_LEVEL_ADMIN])) { ?>
                                    <td class="text-center" rowspan="2" style="vertical-align: middle;">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-backdrop="static" data-target="#editphoneledger" data-ledger-id="<?php echo $entry->ledgerId; ?>">
                                                Edit
                                            </button>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-toggle="modal" data-backdrop="static" data-target="#deletephoneledger" data-ledger-id="<?php echo $entry->ledgerId; ?>">Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                <?php } ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlentities($entry->billingCycleEnd); ?></td>

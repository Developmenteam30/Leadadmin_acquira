...
<?php
			...
			if( $mappings ) {
				...
				printf( "\t\t<td class=\"text-right\" id=\"A%s\" data-format=\"$0,0.00\" data-formula=\"SUM(\$A1,\$A%s)\"></td>\n", ++$row, (sizeOf( $mappings )) );
				printf( "\t\t<td class=\"text-right\" id=\"B%s\" data-format=\"$0,0.00\" data-formula=\"ROUND((\$A%s*0.5)*100)/100\"></td>\n", $row, $row );
				print "\t</tr>\n";
				print "\t</tfoot>\n";
				print "</table>\n";
			}
...
<nav>
	<ul class="nav nav-tabs">
		<li role="presentation" class="active"><a href="#list-owners" aria-controls="list-owners" role="tab" data-toggle="tab">List Owners</a></li>
		<li role="presentation"><a href="#mailers" aria-controls="mailers" role="tab" data-toggle="tab">Mailers</a></li>
	</ul>
</nav>

<!-- Tab panes -->
<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="list-owners">
		<script type="text/javascript">display('dialog_revenue_listowners');</script>
		<div id="dialog_revenue_listowners">Loading ...</div>
	</div>
	<div role="tabpanel" class="tab-pane" id="mailers">
		<script type="text/javascript">display('dialog_revenue_mailers');</script>
		<div id="dialog_revenue_mailers">Loading ...</div>
	</div>
</div>

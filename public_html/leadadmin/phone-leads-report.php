...
LeadsSession::requireAccess([LEADS_SESSION_LEVEL_STAFF, LEADS_SESSION_LEVEL_CLIENT_PHONE_LEADS, LEADS_SESSION_LEVEL_CLIENT_IMPORT, LEADS_SESSION_LEVEL_CLIENT_DASHBOARD]);
...
<div class="container-fluid">
    ...
    if (empty($outgoingFeeds)) {
        ...
        foreach ($outgoingFeeds as $outgoingFeed) {
            ...
            $stats = $leads->getOutboundURLStatsReport($outgoingFeed->idFeedOut, array(), 'total', $statsStart, $statsEnd, 'url', 'url');
    ...
    if (empty($incomingFeeds)) {
        ...
        foreach ($incomingFeeds as $incomingFeed) {
            ...
            $stats = $leads->getInboundURLStatsReport($incomingFeed->idFeedIn, array(), 'total', $statsStart, $statsEnd, 'url', 'url');

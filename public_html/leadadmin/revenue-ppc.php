...
<nav>
	<ul class="nav nav-tabs">
		<li role="presentation" class="active"><a href="#publishers" aria-controls="publishers" role="tab" data-toggle="tab">Publishers</a></li>
		<li role="presentation"><a href="#advertisers" aria-controls="advertisers" role="tab" data-toggle="tab">Advertisers</a></li>
	</ul>
</nav>
...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="publishers">
		<script type="text/javascript">display('dialog_revenue_1listowners');</script>
		<div id="dialog_revenue_listowners">Loading ...</div>
	</div>
	<div role="tabpanel" class="tab-pane" id="advertisers">
		<script type="text/javascript">display('dialog_revenue_1mailers');</script>

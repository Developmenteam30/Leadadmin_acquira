    ...
    foreach ($feedCategories as $categoryKey => $categoryVal) {
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                ?>
                <h4>Incoming <?php echo $categoryVal; ?> Feeds (Last Updated: <?php echo date("m-d g:i:s a"); ?>) <a href="#" class="btn btn-primary btn-xs nonLink" onclick="automaticRefresh = true; autoRefresh();">Refresh</a>
                </h4>
                <?php
                            ...
                            foreach ($companyFeedLists as $idCompany => $companyFeedList) {
                                ...
                                <tr class="clickable striped-master" onclick="toggleHidden('incoming_companyFeedList_<?php echo $categoryKey; ?>', {'sub':<?php echo $idCompany; ?>});">
                                    ...
                                    <td class="text-center dashboard-incoming-col-small">
                                        <button type="button" class="btn <?php echo (empty($feed->lastDate) || strtotime($feed->lastDate) < strtotime('1 month ago')) ? 'btn-danger' : 'btn-primary'; ?> btn-xs"
                                                data-toggle="modal" data-backdrop="static" data-target="#companynotes" data-company-id="<?php echo $idCompany; ?>"><?php echo !empty($feed->lastDate) ? date('Y-m-d',
                                                strtotime($feed->lastDate)) : 'None'; ?></button>
                                    </td>
            ...
            <div class="col-md-6">
                ...
                ?>
                <h4>Outgoing <?php echo $categoryVal; ?> Feeds (Last Updated: <?php echo date("m-d g:i:s a"); ?>) <a href="#" class="btn btn-primary btn-xs nonLink" onclick="automaticRefresh = true; autoRefresh();">Refresh</a>
                </h4>
                <?php
                                        ...
                                        <table class="table table-bordered table-condensed table-striped">
                                            ...
                                            foreach ($companyFeedList as $feed) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right dashboard-outgoing-col-small"><a

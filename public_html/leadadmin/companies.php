...
if (isset($_REQUEST['a'])) {
    ...
    switch ($_REQUEST['a']) {
        case "addNewCompany":
            ...
            if ($c && !empty($_REQUEST['returns_email']) && !filter_var($_REQUEST['returns_email'],
...
<div class="container-fluid">
    ...
    <p>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-backdrop="static"
                data-target="#newcompany">Add a new company
        </button>
    ...
    $fields = array(
        ...
        array(
            ...
            'multiple' => true,
            'placeholder' => false,
            'value' => !empty($_REQUEST['searchDivisions']) && is_array($_REQUEST['searchDivisions']) ? array_combine($_REQUEST['searchDivisions'],
                $_REQUEST['searchDivisions']) : array(),
        ),
        array(
            'id' => 'html_start',
            'type' => '_html',
        ...
        array(
            ...
            'choices' => $verticals,
            'choice_append' => '<br/>',
            'value' => !empty($_REQUEST['searchVerticals']) && is_array($_REQUEST['searchVerticals']) ? array_combine($_REQUEST['searchVerticals'],
                $_REQUEST['searchVerticals']) : array(),
        ),
        array(
            'id' => 'html_start',
            'type' => '_html',
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal"
                                    data-backdrop="static" data-target="#editcompany"
                                    data-company-id="<?php echo $company->idCompany; ?>">Edit
                            </button>
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#" data-toggle="modal" data-backdrop="static" data-target="#companynotes"
                                       data-company-id="<?php echo $company->idCompany; ?>">Notes</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>

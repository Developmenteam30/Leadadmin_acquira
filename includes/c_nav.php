...
if( LeadsSession::isValid( LEADS_SESSION_LEVEL_STAFF ) ) {
	...
	$nav = array(
		...
		array( 'name' => 'Reports', 'level' => LEADS_SESSION_LEVEL_STAFF, 'menu' => array(
			...
			array( 'name' => 'separator', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
			array( 'name' => '*Publisher', 'url' => '/leadadmin/ledger.php?divisionId=2&amp;type=0', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
			array( 'name' => '*Advertiser', 'url' => '/leadadmin/ledger.php?divisionId=2&amp;type=1', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
			array( 'name' => 'separator', 'level' => LEADS_SESSION_LEVEL_ADMIN ),

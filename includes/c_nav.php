...
if( LeadsSession::isValid( LEADS_SESSION_LEVEL_STAFF ) ) {
	...
	$nav = array(
		...
		array( 'name' => 'Reports', 'level' => LEADS_SESSION_LEVEL_STAFF, 'menu' => array(
			...
			array( 'name' => 'separator', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
			array( 'name' => '*Publisher - PPC', 'url' => '/leadadmin/ledger.php?divisionId=3&amp;type=0', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
			array( 'name' => '*Advertiser - PPC', 'url' => '/leadadmin/ledger.php?divisionId=3&amp;type=1', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
			array( 'name' => 'separator', 'level' => LEADS_SESSION_LEVEL_ADMIN ),
